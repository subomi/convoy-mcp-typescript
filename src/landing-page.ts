...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": { "BEARER_AUTH": "YOUR_VALUE_HERE" },
  };
  const codexConfig = `[mcp_servers.Convoy]
url = "${o}/sse"
http_headers = { "bearer-auth" = "YOUR_BEARER_AUTH" }`;
...
<head>
    ...
    <title>@subomi/convoy-mcp-typescript MCP</title>
    <meta name="description" content="Install @subomi/convoy-mcp-typescript MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@subomi/convoy-mcp-typescript - MCP Server">
    <meta property="og:description" content="Install @subomi/convoy-mcp-typescript MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@subomi/convoy-mcp-typescript - MCP Server">
    <meta property="twitter:description" content="Install @subomi/convoy-mcp-typescript MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@subomi/convoy-mcp-typescript</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Convoy&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAc3Vib21pL2NvbnZveS1tY3AtdHlwZXNjcmlwdCIsInN0YXJ0IiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Convoy&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAc3Vib21pL2NvbnZveS1tY3AtdHlwZXNjcmlwdCIsInN0YXJ0IiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=Convoy&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAc3Vib21pL2NvbnZveS1tY3AtdHlwZXNjcmlwdCIsInN0YXJ0IiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=Convoy&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAc3Vib21pL2NvbnZveS1tY3AtdHlwZXNjcmlwdCIsInN0YXJ0IiwiLS1iZWFyZXItYXV0aCIsIiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add Convoy -- npx -y @subomi/convoy-mcp-typescript start --bearer-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/subomi/convoy-mcp-typescript/releases/download/v0.8.0/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add Convoy -- npx -y @subomi/convoy-mcp-typescript start --bearer-auth </code>
        </div>
      </div>
    </div>

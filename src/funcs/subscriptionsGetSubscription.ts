...
import {
  ...
  GetSubscriptionResponse$zodSchema,
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetSubscriptionResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, GetSubscriptionResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, GetSubscriptionResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, GetSubscriptionResponse$zodSchema, {

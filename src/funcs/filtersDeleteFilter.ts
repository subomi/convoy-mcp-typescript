...
import {
  DeleteFilterRequest,
  DeleteFilterRequest$zodSchema,
  DeleteFilterResponse,
  DeleteFilterResponse$zodSchema,
} from "../models/deletefilterop.js";
 ...
 */
export function filtersDeleteFilter(
  client$: ConvoyCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteFilterRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, DeleteFilterResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, DeleteFilterResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, DeleteFilterResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, DeleteFilterResponse$zodSchema, {

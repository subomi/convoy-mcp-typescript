...
import {
  ...
  GetEventsPagedRequest$zodSchema,
  GetEventsPagedResponse,
  GetEventsPagedResponse$zodSchema,
} from "../models/geteventspagedop.js";
 ...
 */
export function eventsGetEventsPaged(
  client$: ConvoyCore,
  request: GetEventsPagedRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetEventsPagedRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetEventsPagedResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, GetEventsPagedResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, GetEventsPagedResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, GetEventsPagedResponse$zodSchema, {

...
import {
  ...
  BulkUpdateFiltersRequest$zodSchema,
  BulkUpdateFiltersResponse,
  BulkUpdateFiltersResponse$zodSchema,
} from "../models/bulkupdatefiltersop.js";
 ...
 */
export function filtersBulkUpdateFilters(
  client$: ConvoyCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => BulkUpdateFiltersRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, BulkUpdateFiltersResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, BulkUpdateFiltersResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, BulkUpdateFiltersResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, BulkUpdateFiltersResponse$zodSchema, {

...
import {
  ...
  DeleteSubscriptionRequest$zodSchema,
  DeleteSubscriptionResponse,
  DeleteSubscriptionResponse$zodSchema,
} from "../models/deletesubscriptionop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteSubscriptionRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, DeleteSubscriptionResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, DeleteSubscriptionResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, DeleteSubscriptionResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, DeleteSubscriptionResponse$zodSchema, {

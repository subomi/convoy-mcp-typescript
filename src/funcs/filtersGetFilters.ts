...
import {
  GetFiltersRequest,
  GetFiltersRequest$zodSchema,
  GetFiltersResponse,
  GetFiltersResponse$zodSchema,
} from "../models/getfiltersop.js";
 ...
 */
export function filtersGetFilters(
  client$: ConvoyCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetFiltersRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetFiltersResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, GetFiltersResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, GetFiltersResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, GetFiltersResponse$zodSchema, {

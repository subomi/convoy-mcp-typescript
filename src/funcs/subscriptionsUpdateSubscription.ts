...
import {
  ...
  UpdateSubscriptionResponse$zodSchema,
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(202, UpdateSubscriptionResponse$zodSchema, {
      key: "twoHundredAndTwoApplicationJsonObject",
    }),
    M.json(400, UpdateSubscriptionResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, UpdateSubscriptionResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, UpdateSubscriptionResponse$zodSchema, {

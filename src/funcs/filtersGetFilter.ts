...
import {
  GetFilterRequest,
  GetFilterRequest$zodSchema,
  GetFilterResponse,
  GetFilterResponse$zodSchema,
} from "../models/getfilterop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetFilterRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetFilterResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, GetFilterResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, GetFilterResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, GetFilterResponse$zodSchema, {

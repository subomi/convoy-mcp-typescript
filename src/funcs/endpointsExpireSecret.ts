...
import {
  ExpireSecretRequest,
  ExpireSecretRequest$zodSchema,
  ExpireSecretResponse,
  ExpireSecretResponse$zodSchema,
} from "../models/expiresecretop.js";
 ...
 */
export function endpointsExpireSecret(
  client$: ConvoyCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ExpireSecretRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.ExpireSecret, { explode: true });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ExpireSecretResponse$zodSchema, {
      key: "twoHundredApplicationJsonObject",
    }),
    M.json(400, ExpireSecretResponse$zodSchema, {
      key: "fourHundredApplicationJsonObject",
    }),
    M.json(401, ExpireSecretResponse$zodSchema, {
      key: "fourHundredAndOneApplicationJsonObject",
    }),
    M.json(404, ExpireSecretResponse$zodSchema, {
